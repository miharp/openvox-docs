...
> **NOTE:** This page was generated from the Puppet source code on 2026-04-06 14:56:20 +0200
...
Information about the cloud instance of the node. This is currently only populated on nodes running in Microsoft Azure, Amazon Web Services, and Google Compute Engine.
...
* `<devicename>` (map) --- Represents a disk or block device.
    ...
    * `serial` (string) --- The serial number of the disk or block device on Linux based systems.
    ...
    * `wwn` (string) --- The identifier for the disk.
...
* `product` (map) --- The system product information.
    ...
    * `version` (string) --- The product model information of the system.
...
* `interfaces` (map) --- The network interfaces of the system.
    * `<interface>` (map) --- Represents a network interface.
        ...
        * `duplex` (string) --- The duplex settings for physical network interfaces on Linux using /sys/class/net.
        ...
        * `operational_state` (string) --- The operational state for Linux based systems.
        * `physical` (boolean) --- Return whether network interface is a physical device on Linux based systems.
        * `scope6` (string) --- The IPv6 scope for the network interface.
        * `speed` (integer) --- The speed of physical network interfaces on Linux using /sys/class/net.
...
* `macosx` (map) --- Represents information about Mac OSX.
    ...
    * `version` (map) --- Represents information about the Mac OSX version.
        * `extra` (string) --- The ProductVersionExtra value. Only supported on macOS 13 and later.
...
* `extensions` (array) --- The CPU extensions the processor supports.
