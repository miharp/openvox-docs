...
> **NOTE:** This page was generated from the Puppet source code on 2026-04-06 14:55:24 +0200
...
The primary Puppet server to which the Puppet agent should connect. This setting is ignored when `server_list` is specified.
